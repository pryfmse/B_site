function Timeline(cvs) {
    ...
    self.dotColors = [
        ['rgba(111, 78, 55)', 'rgba(111, 78, 55, 0.3)', 'rgba(111, 78, 55, 0.1)'],
        ['rgba(51, 51, 51, 0.7)', 'rgba(51, 51, 51, 0.3)', 'rgba(51, 51, 51, 0.1)'],
    ];
    ...
    function init() {
        ...
        try {
            ...
            self.lines[0] = new Line(0, canvas.offsetHeight - 100, 'rgba(111, 78, 55)', self.options, mouse);
            self.lines[1] = new Line(0, canvas.offsetHeight - 100, 'rgba(51, 51, 51)', self.options, mouse);
